...
using Spe.TestServer.Infrastructure.Resilience;
using Spe.TestServer.Infrastructure.Validation;
using Spe.TestServer.Models;
...
builder.Services.AddSingleton<IGraphClientFactory, Spe.TestServer.Infrastructure.Graph.GraphClientFactory>();
